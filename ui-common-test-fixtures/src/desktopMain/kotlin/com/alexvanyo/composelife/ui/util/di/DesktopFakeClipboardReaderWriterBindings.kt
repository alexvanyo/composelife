...
import com.alexvanyo.composelife.ui.util.DesktopClipboardReader
import com.alexvanyo.composelife.ui.util.DesktopClipboardWriter
...
@ContributesTo(
    UiScope::class,
    replaces = [ClipboardReaderWriterImpl::class, DesktopClipboardReader::class, DesktopClipboardWriter::class],
)
@BindingContainer
interface DesktopFakeClipboardReaderWriterBindings {
    companion object {
        @Provides
