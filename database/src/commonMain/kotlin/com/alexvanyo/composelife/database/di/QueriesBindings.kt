...
@BindingContainer
interface QueriesBindings {
    companion object {
        @Provides
        @SingleIn(AppScope::class)
        internal fun providesCellStateQueries(composeLifeDatabase: ComposeLifeDatabase): CellStateQueries =
            composeLifeDatabase.cellStateQueries
