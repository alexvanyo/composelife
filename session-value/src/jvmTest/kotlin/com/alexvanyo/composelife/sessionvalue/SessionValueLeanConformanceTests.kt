 ...
 * matches the Lean 4 formal specification and executable oracle via JVM bytecode at every
 * transition step.
 *
 * This is the JVM counterpart to the linuxX64 `SessionValueLeanConformanceTests` which uses
 * C interop. Both suites exercise identical test logic; they differ only in how the oracle
 * is loaded (JVM reflection vs. Kotlin/Native cinterop).
 */
@OptIn(ExperimentalUuidApi::class)
