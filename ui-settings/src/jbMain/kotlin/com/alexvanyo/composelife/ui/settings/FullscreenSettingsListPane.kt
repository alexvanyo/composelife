...
fun FullscreenSettingsListPane(
    ...
    SettingsCategoryList(
        currentSettingsCategory = fullscreenSettingsListPaneState.settingsCategory,
        showSelectedSettingsCategory =
        fullscreenSettingsListPaneState.isDetailVisible && fullscreenSettingsListPaneState.isListVisible,
...
private fun SettingsCategoryList(
    ...
    Scaffold(
        ...
        Column(
            ...
            SettingsCategory.Companion._values.forEach { settingsCategory ->
...
interface FullscreenSettingsListPaneState : ListDetailInfo {
    /**
