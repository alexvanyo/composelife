...
actual fun UnexpectedInputMessage(input: String, lineIndex: Int, characterIndex: Int): ParameterizedString =
    ParameterizedString(
...
actual fun UnexpectedCharacterMessage(character: Char, lineIndex: Int, characterIndex: Int): ParameterizedString =
    ParameterizedString(
...
actual fun UnexpectedHeaderMessage(header: String): ParameterizedString = ParameterizedString(
    R.string.unexpected_header,
    ParameterizedStringArgument(header),
)

actual fun UnexpectedShortLineMessage(lineIndex: Int): ParameterizedString = ParameterizedString(
    R.string.unexpected_short_line,
    ParameterizedStringArgument(lineIndex),
)

actual fun UnexpectedBlankLineMessage(lineIndex: Int): ParameterizedString = ParameterizedString(
...
actual fun DuplicateTopLeftCoordinateMessage(overwritingOffset: IntOffset): ParameterizedString = ParameterizedString(
...
actual fun UnexpectedNodeIdMessage(lineIndex: Int, characterIndices: IntRange): ParameterizedString =
    ParameterizedString(
