...
class GameOfLifeAlgorithmTests {
    ...
    fun `one generation step flow`() = runTest {
    ...
    @TestParameterInjectorTest
    fun `two generation step flow`() = runTest {
        val (algorithm, job) = algorithmFactory.factory(
            this,
            TestComposeLifeDispatchers(
                StandardTestDispatcher(testScheduler),
    ...
    @TestParameterInjectorTest
    fun `subsequent one generation step`() = runTest {
        val (algorithm, job) = algorithmFactory.factory(
            this,
            TestComposeLifeDispatchers(
                StandardTestDispatcher(testScheduler),
    ...
    @TestParameterInjectorTest
    fun `subsequent two generation step`() = runTest {
        val (algorithm, job) = algorithmFactory.factory(
            this,
            TestComposeLifeDispatchers(
                StandardTestDispatcher(testScheduler),
