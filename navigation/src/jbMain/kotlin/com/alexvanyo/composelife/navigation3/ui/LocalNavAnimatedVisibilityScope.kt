...
/**
 * Local provider of [AnimatedVisibilityScope] to [NavEntry.Content].
 *
 * This does not have a default value since the AnimatedVisibilityScope is provided at runtime by
 * AnimatedContent.
 *
    ...
    compositionLocalOf {
        ...
        throw IllegalStateException(
            "Unexpected access to LocalNavAnimatedVisibilityScope. You should only " +
                "access LocalNavAnimatedVisibilityScope inside a NavEntry passed " +
                "to NavDisplay.",
        )
    }
