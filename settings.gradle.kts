...
include(":dispatchers")
include(":dispatchers-test-fixtures")
include(":do-not-keep-process")
include(":filesystem")
include(":filesystem-test-fixtures")
include(":geometry")
include(":geometry-benchmark")
...
include(":preferences-test-fixtures")
include(":process-lifecycle")
include(":random")
include(":random-test-fixtures")
...
include(":time-util")
include(":tracing")
include(":tracing-test-fixtures")
include(":ui-app")
include(":ui-app-screenshot-tests")
include(":ui-cells")
include(":ui-cells-screenshot-tests")
include(":ui-common")
include(":ui-common-screenshot-tests")
include(":ui-common-test-fixtures")
include(":ui-mobile")
include(":ui-settings")
include(":ui-settings-screenshot-tests")
include(":ui-tooling-preview")
include(":ui-wear")
include(":ui-wear-screenshot-tests")
include(":updatable")
include(":web-app")
include(":wear")
...
include(":wear-watchface-wff-resources")
include(":wear-watchface-wff-version-1")
include(":wear-watchface-wff-version-4")
