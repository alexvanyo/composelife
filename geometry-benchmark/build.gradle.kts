...
android {
    namespace = "com.alexvanyo.composelife.geometry.benchmark"
    defaultConfig {
        applicationId = "com.alexvanyo.composelife.geometry.benchmark"
        minSdk = 30
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
        testInstrumentationRunner = "androidx.benchmark.junit4.AndroidBenchmarkRunner"
        testInstrumentationRunnerArguments["androidx.benchmark.suppressErrors"] = "EMULATOR,UNLOCKED,NOT-AOT-COMPILED"
    }
