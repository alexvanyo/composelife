...
private class PreferencesProtoTransform(previousPreferencesProto: PreferencesProto) : ComposeLifePreferencesTransform {
    ...
    private fun updateQuickAccessSetting(include: Boolean, quickAccessSetting: QuickAccessSetting) {
        val quickAccessSettingProto =
            when (quickAccessSetting) {
...
private fun PreferencesProto.toLoadedComposeLifePreferences(): LoadedComposeLifePreferences {
    val quickAccessSettings =
        quick_access_settings
            .mapNotNull { quickAccessSettingProto ->
...
private val PreferencesProto.roundRectangleSessionValue: SessionValue<RoundRectangle> get() {
    ...
    val sessionId =
        checkNotNull(round_rectangle_session_id.toResolved()) {
            "Round rectangle session id was null!"
        }
    val valueId =
        checkNotNull(round_rectangle_value_id.toResolved()) {
...
private val PreferencesProto.patternCollectionsSynchronizationPeriodSessionValue: SessionValue<DateTimePeriod> get() {
    ...
    val sessionId =
        checkNotNull(pattern_collections_synchronization_period_session_id.toResolved()) {
            "Pattern collections synchronization period session id was null!"
        }
    val valueId =
        checkNotNull(pattern_collections_synchronization_period_value_id.toResolved()) {
