...
class TemporalGameOfLifeStateTransformTests {
    ...
    @Test
    fun state_is_advanced_correctly() = runTest(testDispatcher) {
        val hashLifeAlgorithm = HashLifeAlgorithm(
            dispatchers = dispatchers,
            tracer = TestTraceDriver().tracer,
        )

        val state = transform<TemporalGameOfLifeState?>(
            initialValue = null,
        ...
        val temporalGameOfLifeState = assertNotNull(state.value)
    ...
    @Test
    fun multiple_evolutions_is_correct() = runTest(testDispatcher) {
        val hashLifeAlgorithm = HashLifeAlgorithm(
            dispatchers = dispatchers,
            tracer = TestTraceDriver().tracer,
        )
    ...
    @Test
    fun state_is_advanced_correctly_with_step() = runTest(testDispatcher) {
        val hashLifeAlgorithm = HashLifeAlgorithm(
            dispatchers = dispatchers,
            tracer = TestTraceDriver().tracer,
        )
