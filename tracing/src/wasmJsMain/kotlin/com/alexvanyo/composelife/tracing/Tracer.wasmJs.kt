...
actual abstract class AbstractTraceDriver protected actual constructor(
    actual val sink: AbstractTraceSink,
...
actual abstract class Counter {
    actual abstract fun name(): String
    actual abstract fun setValue(value: Long)
    actual abstract fun setValue(value: Double)
}
...
actual inline fun <T> Tracer.trace(
    category: String,
    name: String,
    crossinline block: () -> T,
): T = block()
