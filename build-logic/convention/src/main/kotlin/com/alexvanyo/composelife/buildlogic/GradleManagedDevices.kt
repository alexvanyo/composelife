...
fun getGradleManagedDeviceConfig(formFactors: Set<FormFactor>): Set<GradleManagedDeviceConfig> = formFactors
    .map { formFactor ->
        when (formFactor) {
